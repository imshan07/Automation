...
public class PageBase {
    ...
    public static String VideoRecording_FOLDER = System.getProperty("user.dir") + "/src/test/resources/VideoRecording/";
...
//                break;
     ...
     *  * Implicit Wait
     *  */
    public static void implicitWait(By firstname, int seconds)
    {
